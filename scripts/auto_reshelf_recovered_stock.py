...
from xianyu_open.payload_builder import build_publish_payload, load_publish_defaults
...
def main():
    ...
    for row in rows:
        ...
        try:
            ...
            print(f"已重新上架提交: task={row['task_id']} | product={row['product_id']} | stock={row['stock']}")
            republish_count += 1
