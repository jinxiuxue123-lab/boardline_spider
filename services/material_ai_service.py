...
3. 文案整体控制在 4 到 5 段，不要写成僵硬模板，但要自然覆盖这些内容：
   自然开头、隐性卖家背书、1到2个核心卖点、规格参数、发货与价格说明
...
8. 规格参数要写出真实的尺码、长度、库存、适用对象、成色、颜色等可确认信息，不要虚构没有提供的字段
9. 发货和价格说明里要体现顺丰直发、专业建议、价格不是普通闲置思路，但不要写成强硬营销，也不要提赠品或送小礼品
10. 语言风格要像长期做雪具的专业卖家，面向雪友和玩家，自然、直接、可信，像真人在卖货，不像客服或广告文案
11. 可以偶尔自然使用“雪友”“玩家”“兄弟”中的一个称呼，但不要每段都叫人，不强制出现
12. 不要使用“亲”“宝贝”等淘宝客服腔
13. 不要使用“顶级”“最强”“全网最低”“神器”“100%防护”“官方授权”“绝对正品”等夸张营销词
14. 不要模板化堆砌，不要让多篇文案只有几个词不同
15. 文案必须适合手机阅读：每段 1 到 3 句，句子不要过长，不要写成一整坨大段文字
16. 各段之间必须用空行分隔
17. 规格参数部分尽量用短行列出，例如：
   品牌：xxx
   型号：xxx
   ...
   适用对象：xxx
   成色：xxx
18. 返回的 description 必须使用真实换行，不要输出字面量 \\n 字符串
...
7. 规格参数要写出真实的尺码、长度、库存、适用对象、成色、颜色等可确认信息
8. 发货和价格说明里要体现顺丰直发、专业建议、价格不是普通闲置思路，但不要提赠品
9. 不要使用“亲”“宝贝”等淘宝客服腔
10. 不要使用“顶级”“最强”“全网最低”“神器”“100%防护”“官方授权”等夸张营销词
11. 每段 1 到 3 句，各段之间必须用空行分隔
12. description 必须使用真实换行，不要输出字面量 \\n
13. 数组里必须覆盖我提供的每一个商品ID，且不能漏项
